...
<template>
    ...
    <div class="w-full py-4 grid grid-cols-1 sm:grid-cols-3 it-ce shadow-[0px_3px_6px_0px_rgb(0,0,0,0.1)] text-center" v-if="isAuthenticated">
    ...
    <div class="w-full py-4 grid grid-cols-1 sm:grid-cols-2 it-ce shadow-[0px_3px_6px_0px_rgb(0,0,0,0.1)] text-center" v-if="isAuthenticated">
